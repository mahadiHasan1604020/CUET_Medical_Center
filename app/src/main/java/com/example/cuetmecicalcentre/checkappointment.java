...
public class checkappointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonThree = findViewById(R.id.button7);
        buttonThree.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                System.out.println("Button Clicked");

                Intent prescribeIntent = new Intent(getApplicationContext(), MakePrescription.class);
                startActivity(prescribeIntent);
            }
        });
        Button buttonFour = findViewById(R.id.button9);
